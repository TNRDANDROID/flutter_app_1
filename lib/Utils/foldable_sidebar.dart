...
class FoldableSidebarBuilder extends StatelessWidget {
  ...
  const FoldableSidebarBuilder({ Key? key, required this.status, required this.drawer, required this.screenContents,  required this.drawerBackgroundColor}) : super(key: key);
